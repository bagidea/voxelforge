...
1. ตัวเลข CURRENT ทั้งหมดมาจากเพลตที่ shoot ไว้ก่อนหน้านี้ (08-11 / 08-14) ซึ่ง **ยังไม่มี**
   การแก้ `exp_comp` ที่ค้างอยู่ใน working tree ⇒ แกนฟ้า (#7–#9) ต้องวัดใหม่หลัง fix land
2. ต้นเหตุ #1 (หมอก) กับ #2 (พื้นเงา) เป็น **การคำนวณจากค่าคงที่ที่ shipped + ขนาดแผนที่จริง**
   ...
   มีคนถืออยู่ในนาทีนี้ การ build จะได้ binary ที่ไม่ตรงกับ HEAD และไม่ตรงกับใครเลย
