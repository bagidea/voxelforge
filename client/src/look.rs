...
/// Distance (blocks) at which the distance haze starts to bite. Everything
/// nearer than this renders with ZERO fog — the reference frames keep
/// mid-distance pine trees fully saturated and razor sharp, and an exponential
/// haze that starts at the camera cannot do that.
...
/// desaturates the mid-distance geometry the reference frames keep vivid.
